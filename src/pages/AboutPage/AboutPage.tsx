...
export function AboutPage() {
  return (
    <div className="space-y-10 text-[rgb(var(--fg))]">
      <Seo
        title="space-H — About"
        description="Profile, stack, learning timeline, and apprenticeship goals."
      />

      {/* ================= HERO ================= */}
      <section className="relative overflow-hidden rounded-3xl border border-[rgb(var(--border))] bg-[rgb(var(--bg-soft))] p-6 sm:p-10 backdrop-blur-xl">
        ...
        <div className="relative space-y-4">
          ...
          <p className="max-w-2xl text-sm text-[rgb(var(--fg-muted))]">
          ...
          {timeline.map((item) => (
            <Card key={item.title}>
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="shrink-0 text-sm text-[rgb(var(--fg))/0.55]">
                  {item.period}
                </div>
              </div>
            </Card>
